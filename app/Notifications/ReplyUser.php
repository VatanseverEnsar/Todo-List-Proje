...
class ReplyUser extends Notification
{
    use Queueable;
    protected $data;
    /**
    ...
    public function toMail($notifiable) {
        return (new MailMessage)
                        ...
                        ->line('Sisteme daha önce gönderilmiş olduğunuz destek talebi için yönetici tarafından bir yanıt gönderildi. Destek talebini incelemek için aşağıda ki bağlantıya tıklayınız.')
